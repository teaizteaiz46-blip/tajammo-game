...
/* الكلمات الي تنمسك كجزء من كلمة (تمسك السوابق واللواحق العربية تلقائياً)،
   والكلمات الي لازم تنطابق كلمة كاملة لأن جزءها يظهر بكلمات سليمة:
   «نيك» بسبوتنيك وتكنيك، «اقتل» باقتلاع، «عرص» بعرصة، rape بـgrape. */
const BANNED_PART = [
  'طيز','شرموط','قحب','عاهر','لوطي','منيوك','زاني','سكس','اباحي','بورن',
  'ديوث','يلعن','نذبح','حقير',
  'fuck','shit','bitch','whore','slut','cunt','porn','nigger','faggot'
];
const BANNED_WORD = ['كس','زب','خول','نيك','اقتل','عرص','dick','rape'];
